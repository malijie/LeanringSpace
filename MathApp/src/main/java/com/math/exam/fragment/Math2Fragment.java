...
public class Math2Fragment extends BaseFragment{
    ...
    private static final String[]VIDEO_ITEM = Data.VIDEO_ITEM2;
    private static final String[] VIDEO_URL = Data.VIDEO_URL2;
    private static final int[]VIDEO_LENGTH = Data.VIDEO_LENGTH2;
//
    ...
    private void showPayTip() {
        final CustomDialog dialog = new CustomDialog(getActivity(), R.layout.dialog_layout, PayBaseInfo.ITEM_MATH2_VIDEO,PayBaseInfo.ITEM_MATH2_VIDEO_DESCR);
        dialog.setButtonClickListener(new CustomDialog.DialogButtonListener() {
            @Override
            public void onConfirm() {

                if(PermissionController.checkPermission(getActivity())){
                    mPayManager.payForMathVideo(PayBaseInfo.MATH2);
                    dialog.dissmiss();
                }else{
